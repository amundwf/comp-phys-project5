...
int JacobiSolverLithosphere(int N, double dx, double dt, double t, double alpha, arma::mat &A, arma::mat &A_prev, double abstol, double gamma, double eta, bool enrichment);
