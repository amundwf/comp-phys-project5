...
if plotCodeWord == 'colormesh':
    ...
    print('u_xt_list.shape:'); print(u_xt_list.shape)
    print('v_xt_list.shape:'); print(v_xt_list.shape)
    #print('v_xt_list:'); print(v_xt_list)

    #print('xList:'); print(xList)
    #print('u_xt_list:'); print(u_xt_list)
    minus_f_x_list = (-ut.f(xList,1))[:,0]
    print('minus_f_x_list.shape:'); print(minus_f_x_list.shape)

    #print('v_xt_list:'); print(v_xt_list)
    #print('minus_f_x_list:'); print(minus_f_x_list)
    u_xt_list_simple_sum = v_xt_list + minus_f_x_list
    print('u_xt_list_simple_sum.shape:'); print(u_xt_list_simple_sum.shape)
